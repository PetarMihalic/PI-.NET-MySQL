...
namespace OnlineFanShop
{
    public partial class frmPocetnaAdmin : Form
    {
        ...
        {
            frmKosarica form = new frmKosarica(1);
            form.ShowDialog();
        }
        ...
        {
            frmUpravljanjeUlogama form = new frmUpravljanjeUlogama();
            form.ShowDialog();
        }
        ...
        {
            frmListaZelja form = new frmListaZelja(1);
            form.ShowDialog();
        }
        ...
        {
            frmPopisPonudeReport form = new frmPopisPonudeReport();
            form.ShowDialog();
        }
    }
}
